...
void shopping :: menu()
{
    ...
    switch(choice)
    {
        ...
        if(email=="varsha@email.com" && password=="var@123")
        {
            administrator();
        }
        else
...
void shopping ::receipt()
{
    ...
    else
    {
        ...
        cout<<"\n\n_____________________________________________RECEIPT______________________________________________\n";
